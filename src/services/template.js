...
<head>
  ...
  <title>Gamera - Servicios de Comunicación</title>
</head>
 <body class="body">
                 ...
                 <tr>
                  <td width="560" class="esd-container-frame" align="center" valign="top">
                   <table cellpadding="0" cellspacing="0" width="100%">
                    <tbody>
                     <tr>
                      <td align="center" class="esd-block-image es-p10t es-p10b" style="font-size: 0px;"><a target="_blank"><img src="https://feberqd.stripocdn.email/content/guids/CABINET_c0e87147643dfd412738cb6184109942/images/151618429860259.png" alt="" style="display: block;" width="100"></a></td>
                     </tr>
                     <tr>
                      <td align="center" class="esd-block-text es-p10b es-m-txt-c"><h1 style="font-size: 46px; line-height: 100%;">Thanks for&nbsp;choosing us!</h1></td>
                     </tr>
                    </tbody>
                   </table></td>
                 </tr>
                 ...
                 <tr>
                  <td width="560" class="esd-container-frame" align="center" valign="top">
                   <table cellpadding="0" cellspacing="0" width="100%">
                    <tbody>
                     <tr>
                      <td align="center" class="esd-block-text es-p5t es-p5b es-p40r es-p40l es-m-p0r es-m-p0l"><p>Your order&nbsp;has now been completed!&nbsp;<br>We’ve attached your <strong>receipt </strong>to this email.</p></td>
                     </tr>
                     <tr>
                      <td align="center" class="esd-block-button es-p10t es-p10b"><span class="es-button-border"><a href="" class="es-button" target="_blank">MY ACCOUNT</a></span></td>
                     </tr>
                    </tbody>
                   </table></td>
                 </tr>
                     ...
                     <tr>
                      <td width="70" class="es-m-p0r esd-container-frame" align="center">
                       <table cellpadding="0" cellspacing="0" width="100%">
                        <tbody>
                         <tr>
                          <td align="center" class="esd-block-image" style="font-size: 0px;"><a target="_blank"><img class="adapt-img" src="https://feberqd.stripocdn.email/content/guids/CABINET_c67048fd0acf81b47e18129166337c05/images/79021618299486570.png" alt="" style="display: block;" width="70"></a></td>
                         </tr>
                        </tbody>
                       </table></td>
                     </tr>
                     ...
                     <tr>
                      <td width="70" class="es-m-p0r esd-container-frame" align="center">
                       <table cellpadding="0" cellspacing="0" width="100%">
                        <tbody>
                         <tr>
                          <td align="center" class="esd-block-image" style="font-size: 0px;"><a target="_blank"><img class="adapt-img" src="https://feberqd.stripocdn.email/content/guids/CABINET_c67048fd0acf81b47e18129166337c05/images/43961618299486640.png" alt="" style="display: block;" width="70"></a></td>
                         </tr>
                        </tbody>
                       </table></td>
                     </tr>
                 ...
                 <tr>
                  <td width="560" class="es-m-p0r esd-container-frame" align="center">
                   <table cellpadding="0" cellspacing="0" width="100%" style="border-top: 2px solid #efefef; border-bottom: 2px solid #efefef;">
                    <tbody>
                     <tr>
                      <td align="right" class="esd-block-text es-m-txt-r es-p10t es-p20b"><p>Subtotal:&nbsp;<strong>$40.00</strong><br>Shipping:&nbsp;<strong>$0.00</strong><br>Tax:&nbsp;<strong>$10.00</strong><br>Total:&nbsp;<strong>$50.00</strong></p></td>
                     </tr>
                    </tbody>
                   </table></td>
                 </tr>
                 ...
                 <tr>
                  <td width="280" class="es-m-p0r esd-container-frame es-m-p20b" align="center">
                   <table cellpadding="0" cellspacing="0" width="100%">
                    <tbody>
                     <tr>
                      <td align="left" class="esd-block-text"><p>Customer: <strong>sarah_powell@domain.com</strong></p><p>Order number:&nbsp;<strong>#65000500</strong></p><p>Invoice date:&nbsp;<strong>Apr 17, 2021</strong></p><p>Payment method:&nbsp;<strong>PayPal</strong></p><p>Currency:&nbsp;<strong>USD</strong></p></td>
                     </tr>
                    </tbody>
                   </table></td>
                 </tr>
                 ...
                 <tr>
                  <td width="280" class="es-m-p0r esd-container-frame" align="center">
                   <table cellpadding="0" cellspacing="0" width="100%">
                    <tbody>
                     <tr>
                      <td align="left" class="esd-block-text es-m-txt-l"><p>Shipping Method: <strong>UPS - Ground</strong></p><p>Shipping address:</p><p><strong>Sarah Powell,<br>600 Montgomery St,<br>San Francisco, CA 94111</strong></p></td>
                     </tr>
                    </tbody>
                   </table></td>
                 </tr>
                 ...
                 <tr>
                  <td width="560" align="left" class="esd-container-frame">
                   <table cellpadding="0" cellspacing="0" width="100%">
                    <tbody>
                     <tr>
                      <td align="center" class="esd-block-text es-p10t es-p10b"><p>Got a question?&nbsp;Email us at&nbsp;<a target="_blank" href="mailto:">support@</a><a target="_blank" href="mailto:">stylecasual</a><a target="_blank" href="mailto:">.com</a>&nbsp;or give us a call at&nbsp;<a target="_blank" href="tel:">+000 123 456</a>.</p></td>
                     </tr>
                    </tbody>
                   </table></td>
                 </tr>
                     ...
                     <tr>
                      <td align="center" class="esd-block-social es-p15t es-p15b" style="font-size:0">
                       <table cellpadding="0" cellspacing="0" class="es-table-not-adapt es-social">
                        <tbody>
                         <tr>
                          <td align="center" valign="top" class="es-p40r"><a target="_blank" href=""><img title="Facebook" src="https://feberqd.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png" alt="Fb" width="32"></a></td>
                          <td align="center" valign="top" class="es-p40r"><a target="_blank" href=""><img title="X.com" src="https://feberqd.stripocdn.email/content/assets/img/social-icons/logo-black/x-logo-black.png" alt="X" width="32"></a></td>
                          <td align="center" valign="top" class="es-p40r"><a target="_blank" href=""><img title="Instagram" src="https://feberqd.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png" alt="Inst" width="32"></a></td>
                          <td align="center" valign="top"><a target="_blank" href=""><img title="Youtube" src="https://feberqd.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png" alt="Yt" width="32"></a></td>
                         </tr>
                        </tbody>
                       </table></td>
                     </tr>
